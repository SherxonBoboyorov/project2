...
@section('content')
        ...
        <div class="flex justify-between items-center flex-wrap [@media(min-width:850px)]:h-[500px] [@media(max-width:850px)]:h-fit">
          ...
          <div class="col [@media(max-width:850px)]:mb-2 pb-3 [@media(min-width:850px)]:w-[48%] [@media(max-width:850px)]:w-full h-fit flex justify-start items-center" >
            <div class="text-content">
              ...
              <a href="#" class="uppercase bg-[#0D2668] px-5 py-3 text-[white] text-[18px] max-sm:text-[15px] font-[500]" >
                Узнать больше
              </a>
      ...
      <div class="slider-rooms mb-10">
        <div
          class="swiper [@media(min-width:1000px)]:h-[600px] [@media(min-width:850px)]:h-[500px] [@media(min-width:650px)]:h-[400px] [@media(max-width:650px)]:h-[350px] mySwiper w-full"
        >
          <!-- Slide wrapper start -->
          <div
            class="swiper-wrapper h-full [&>.swiper-slide.swiper-slide-active]:opacity-100"
          >
            <!-- Slides start -->
            @foreach ($houseimages as $houseimage)

            <div
              class="swiper-slide transition-all duration-[0.25s] ease-linear opacity-50 h-[90%] overflow-hidden"
            >
              <!-- Slide Img start -->
              <img
                src="{{ asset($houseimage->image) }}"
                class="transition-all duration-[0.2s] ease-linear w-full h-full object-cover hover:scale-[1.05]"
                alt=""
              />
              <!-- Slide Img end -->
      ...
      <div class="bg-[#F3F4F7] w-full mx-auto">
              ...
              <form action="" method="get" class="my-3">
                <div class="input-content my-5">
                  <input
                    id="userName-first"
                    type="text"
                    class="w-full [@media(min-width:576px)]:h-[40px] [@media(max-width:576px)]:h-[35px] px-3 my-2 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[#696969] outline-none border-none bg-white"
                    placeholder="Имя"
                  />
                  <input
                    id="userNumber-first"
                  ...
                  />
                  <textarea
                    id="userComment-first"
                    rows="3"
                    class="w-full px-3 my-2 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[#696969] outline-none border-none bg-white"
                    placeholder="Комментарий"
                  ></textarea>
                </div>
                <div
                  class="button-content mt-3 w-full flex justify-center items-center"
                >
                  <button
                    id="sent-feedback-button"
                    type="button"
                    class="border-none [@media(min-width:576px)]:py-2 [@media(min-width:576px)]:px-6 [@media(max-width:576px)]:py-1 [@media(max-width:576px)]:px-5 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[white] bg-[#0D2668]"
                  >
                    Отправить
                  </button>
                </div>
        ...
        <div class="feedback max-w-screen-xl mx-auto px-3 py-16">
          <!-- Text content start -->
          <div
            class="text-content pl-3 pr-4 mx-auto max-w-[1000px] overflow-hidden"
          >
            <!-- Title start -->
            <div
              class="title text-center [@media(min-width:576px)]:text-[35px] [@media(max-width:576px)]:text-[26px] text-[#0D2668] font-[600]"
            >
          ...
          <div
            id="videosWrapper"
            class="card-wrapper mt-3 w-full mx-auto flex flex-wrap"
          >
            <div
              class="video-card 1 [@media(min-width:500px)]:w-[33.3%] [@media(min-width:420px)]:w-[50%] [@media(max-width:420px)]:w-[100%] overflow-hidden p-2"
            >
              <div class="w-full shadow-md h-full bg-white">
                <div
                  class="img-content [@media(min-width:768px)]:h-[250px] [@media(min-width:650px)]:h-[180px] [@media(min-width:420px)]:h-[120px] [@media(max-width:420px)]:h-[180px] relative"
                >
                  <div
                    id="video-play-btn"
                    class="play [@media(min-width:768px)]:w-[40px] [@media(min-width:768px)]:h-[40px] [@media(max-width:768px)]:w-[25px] [@media(max-width:768px)]:h-[25px] cursor-pointer absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]" >
                    <svg
                      onclick="activeVideo(event)"
                    ...
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M30 0C13.4314 0 0 13.4316 0 30C0 46.5684 13.4314 60 30 60C46.5686 60 60 46.5684 60 30C60 13.4316 46.5686 0 30 0ZM26 36.9282L38 30L26 23.0718V36.9282Z"
                        fill="white"
                      />
                    </svg>
                  </div>
                  <a data-fancybox href="https://youtu.be/yxq2sirgexU">
                    <img
                      id="videoImg"
                ...
                >
                  ...
                  <div class="text-content py-2 h-full w-full overflow-hidden">
                    ...
                    <!-- Description start -->
                    <div
                      class="description mt-1 [@media(min-width:700px)]:max-h-[115px] [@media(max-width:700px)]:max-h-[60px] overflow-hidden [@media(min-width:700px)]:text-[15px] [@media(max-width:700px)]:text-[13px]"
                    >
                      LoremLorem Lorem ipsu LoremLorem
                    </div>
                    <!-- Description end -->
                  </div>
                  <!-- Text Content end -->
            ...
            <div
              class="video-card 2 [@media(min-width:500px)]:w-[33.3%] [@media(min-width:420px)]:w-[50%] [@media(max-width:420px)]:w-[100%] overflow-hidden p-2"
            >
              <div class="w-full shadow-md h-full bg-white">
                <div
                  class="img-content [@media(min-width:768px)]:h-[250px] [@media(min-width:650px)]:h-[180px] [@media(min-width:420px)]:h-[120px] [@media(max-width:420px)]:h-[180px] relative"
                >
                  ...
                  <a data-fancybox href="https://youtu.be/7VxGSQODmJU">
                    <img
                      id="videoImg"
                      class="w-full h-full object-cover"
                      src="./src/images/slider-room-1.jpg"
            ...
            <div
              class="video-card 3 [@media(min-width:500px)]:w-[33.3%] [@media(min-width:420px)]:w-[50%] [@media(max-width:420px)]:w-[100%] overflow-hidden p-2"
            >
              <div class="w-full shadow-md h-full bg-white">
                <div
                  class="img-content [@media(min-width:768px)]:h-[250px] [@media(min-width:650px)]:h-[180px] [@media(min-width:420px)]:h-[120px] [@media(max-width:420px)]:h-[180px] relative"
          ...
          >
            <button
              onclick="moreVideo()"
              type="button"
              class="border-none mt-5 [@media(min-width:576px)]:py-2 [@media(min-width:576px)]:px-6 [@media(max-width:576px)]:py-1 [@media(max-width:576px)]:px-5 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[white] bg-[#0D2668]"
            >
              больше
            </button>
          </div>
              ...
              <form action="" method="get" class="my-3">
                <div class="input-content">
                  <input
                    ...
                    required
                    type="text"
                    class="w-full [@media(min-width:576px)]:h-[40px] [@media(max-width:576px)]:h-[35px] px-3 my-2 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[#696969] outline-none border-none bg-[#F3F4F7]"
                    placeholder="Имя" />
                  <input
                    id="userNumber-second"
                    required
                    type="number"
                    class="w-full [@media(min-width:576px)]:h-[40px] [@media(max-width:576px)]:h-[35px] px-3 my-2 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[#696969] outline-none border-none bg-[#F3F4F7]"
                    placeholder="Телефон"
                  />
                  <textarea
                    id="userComment-second"
                    required
                    type="text"
                    class="w-full h-[100px] px-3 my-2 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[#696969] outline-none border-none bg-[#F3F4F7]"
                    placeholder="Комментарий"
                  ></textarea>
                </div>
                <div class="upload-video mb-5 w-full">
                  ...
                  <label
                    for="file"
                    class="border text-center block bg-white border-[#0D2668] [@media(min-width:576px)]:py-2 [@media(min-width:576px)]:px-6 [@media(max-width:576px)]:py-1 [@media(max-width:576px)]:px-5 [@media(min-width:576px)]:text-[18px] [@media(max-width:576px)]:text-[16px] text-[#0D2668]"
                  >
                    Загрузить видео
                  </label>
                </div>
        ...
        <div class="accordion pt-14 pb-16 px-4 mx-auto bg-[white]">
          <!-- Text content start -->
          <div
            class="text-content mx-auto max-w-[1000px] w-full overflow-hidden"
          >
            <!-- Title start -->
            <div
              class="title text-center text-[#0D2668] [@media(min-width:768px)]:text-[40px] [@media(min-width:576px)]:text-[30px] [@media(max-width:576px)]:text-[24px] font-[600]"
            >
              Обратная связь
            </div>
            <!-- Title end -->
            ...
            <!-- Description start -->
            <div
              class="description text-center text-white [@media(min-width:576px)]:mt-3 [@media(max-width:576px)]:mt-1 [@media(min-width:768px)]:text-[20px] [@media(max-width:768px)]:text-[18px] [@media(max-width:576px)]:text-[14px]"
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </div>
            <!-- Description end -->
          ...
          <div class="max-w-[800px] mx-auto">
            <div class="relative" x-data="{selected:null}">
              <button
                type="button"
                class="w-full border-t border-b py-5 text-left flex justify-between items-center"
                @click="selected !== 1 ? selected = 1 : selected = null"
              >
                <div
                  class="title [@media(min-width:576px)]:text-[20px] [@media(max-width:576px)]:text-[17px] font-[600] text-[#0D2668]"
                >
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit?
                </div>
                ...
                <div class="plus-icon w-[18px] he-[18px]">
                  ...
                  >
                    ...
                    <path
                      d="M13 8.74224e-08L13 24H11L11 0L13 8.74224e-08Z"
                      fill="#0D2668"
                    />
                  </svg>
                </div>
              ...
              >
                <div
                  class="py-5 text-description [@media(min-width:576)]:text-[18px] [@media(max-width:576)]:text-[14px] text-[#0D2668]"
                >
        ...
        <!-- Numbers start -->
        <div
          class="feedback-number form w-full py-20 mx-auto relative bg-no-repeat bg-center bg-cover flex flex-wrap justify-center items-center pl-3 pr-4"
          style="background-image: url('./src/images/slider-room-3.jpg')"
        >
          <div class="content w-full max-w-screen-lg mx-auto">
            ...
            <div
              class="number-wrapper flex flex-wrap justify-between items-start py-5 w-full mx-auto"
            >
              <div
                class="items [@media(min-width:600px)]:w-[30%] [@media(max-width:600px)]:w-[100%]"
              >
                <div
                  class="title text-center text-[white] [@media(min-width:768px)]:text-[60px] [@media(min-width:650px)]:text-[50px] [@media(max-width:650px)]:text-[40px] font-[600]"
                >
                  100
                </div>
                <hr
              ...
              <div
                class="items [@media(min-width:600px)]:w-[30%] [@media(max-width:600px)]:w-[100%] [@media(max-width:600px)]:my-7"
              >
                <div
                  class="title text-center text-[white] [@media(min-width:768px)]:text-[60px] [@media(min-width:650px)]:text-[50px] [@media(max-width:650px)]:text-[40px] font-[600]"
                >
      ...
      <div class="ads-integration mx-auto py-10 max-w-screen-xl">
        ...
        <div class="text-content mx-auto max-w-[700px] overflow-hidden px-3">
          <!-- Title start -->
          <div
            class="title text-center text-[#0D2668] [@media(min-width:768px)]:text-[40px] [@media(max-width:768px)]:text-[30px] [@media(max-width:576px)]:text-[24px] font-[600]"
          >
          ...
          <!-- Description start -->
          <div
            class="description text-center [@media(min-width:576px)]:mt-3 [@media(max-width:576px)]:mt-1 text-[#696969] [@media(min-width:768px)]:text-[20px] [@media(max-width:768px)]:text-[18px] [@media(max-width:576px)]:text-[14px]"
          >
        ...
        <div
          class="card-wrapper px-3 mt-8 w-full mx-auto flex justify-between items-center flex-wrap"
        >
          <div
            class="card py-5 [@media(min-width:768px)]:w-[31%] [@media(min-width:500px)]:w-[48%] [@media(max-width:500px)]:w-[100%]"
          >
            <div
              class="img bg-[#EEF0F4] w-[55px] h-[55px] rounded-full overflow-hidden mx-auto p-3"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-full h-full"
            ...
            <div
              class="title text-center my-2 text-[#0D2668] font-[600] text-[24px]"
            >
              Узнаваемость
            </div>
            <div
              class="description text-center overflow-hidden text-[#696969] max-h-[145px] text-[16px]"
            >
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M29.1669 14.7296C26.0659 12.937 22.4699 12.1911 18.9118 12.6025C15.3536 13.0138 12.0227 14.5605 9.41249 17.0134C6.8023 19.4663 5.05176 22.6947 4.42027 26.2205C3.78878 29.7462 4.30993 33.3816 5.90651 36.5879C6.20234 37.1817 6.30026 37.8587 6.12943 38.5004L5.13568 42.2108C5.03707 42.5783 5.03697 42.9652 5.13537 43.3328C5.23378 43.7003 5.42722 44.0354 5.69625 44.3044C5.96528 44.5735 6.3004 44.7669 6.66792 44.8653C7.03543 44.9637 7.42238 44.9636 7.78984 44.865L11.4982 43.8713C12.1422 43.7102 12.8229 43.7895 13.4128 44.0942C16.6191 45.6907 20.2545 46.2119 23.7802 45.5804C27.3059 44.9489 30.5344 43.1984 32.9873 40.5882C35.4401 37.978 36.9868 34.647 37.3982 31.0889C37.8095 27.5308 37.0637 23.9348 35.2711 20.8337"
                  stroke="#0D2668"
                  stroke-width="2"
                  stroke-linecap="round"
                />
                <path
                  d="M37.5003 30.2129C37.6388 30.1548 37.7763 30.0943 37.9128 30.0316C38.667 29.6879 39.5128 29.5587 40.3149 29.7733L41.3066 30.0379C41.7654 30.1602 42.2483 30.1597 42.7069 30.0365C43.1654 29.9133 43.5836 29.6718 43.9193 29.336C44.2551 29.0003 44.4966 28.5821 44.6198 28.1236C44.743 27.665 44.7435 27.1821 44.6212 26.7233L44.3566 25.7316C44.142 24.9295 44.2732 24.0837 44.617 23.3295C45.4217 21.5651 45.8367 19.648 45.8337 17.7087C45.8378 15.1529 45.1153 12.6486 43.7503 10.4879M19.792 12.492C20.5535 10.6685 21.7047 9.03374 23.1649 7.7023C24.6251 6.37086 26.359 5.37503 28.2448 4.78466C30.1307 4.19429 32.1229 4.02368 34.0816 4.28479C36.0404 4.54591 37.9183 5.23243 39.5837 6.2962"
                  stroke="#0D2668"
                  stroke-width="2"
                  stroke-linecap="round"
                />
                <path
                  d="M13.5791 29.167H13.5999M20.852 29.167H20.8708M28.1249 29.167H28.1437"
                  stroke="#0D2668"
                  stroke-width="3"
                  stroke-linecap="round"
          ...
          >
            <div
              class="img bg-[#EEF0F4] w-[55px] flex justify-center items-center h-[55px] rounded-full overflow-hidden mx-auto p-3"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-full x-full"
              ...
              >
                <path
                  d="M42.1875 14.4531H10.9375C10.4195 14.4531 9.92271 14.2473 9.55643 13.8811C9.19015 13.5148 8.98438 13.018 8.98438 12.5C8.98438 11.982 9.19015 11.4852 9.55643 11.1189C9.92271 10.7527 10.4195 10.5469 10.9375 10.5469H37.5C37.8108 10.5469 38.1089 10.4234 38.3286 10.2036C38.5484 9.98387 38.6719 9.6858 38.6719 9.375C38.6719 9.0642 38.5484 8.76613 38.3286 8.54636C38.1089 8.32659 37.8108 8.20313 37.5 8.20312H10.9375C9.7979 8.20312 8.70497 8.65583 7.89915 9.46165C7.09333 10.2675 6.64062 11.3604 6.64062 12.5V37.5C6.64062 38.6396 7.09333 39.7325 7.89915 40.5383C8.70497 41.3442 9.7979 41.7969 10.9375 41.7969H42.1875C42.9127 41.7969 43.6082 41.5088 44.121 40.996C44.6338 40.4832 44.9219 39.7877 44.9219 39.0625V17.1875C44.9219 16.4623 44.6338 15.7668 44.121 15.254C43.6082 14.7412 42.9127 14.4531 42.1875 14.4531ZM42.5781 39.0625C42.5781 39.1661 42.537 39.2655 42.4637 39.3387C42.3905 39.412 42.2911 39.4531 42.1875 39.4531H10.9375C10.4195 39.4531 9.92271 39.2474 9.55643 38.8811C9.19015 38.5148 8.98438 38.018 8.98438 37.5V16.3262C9.58866 16.6363 10.2583 16.7977 10.9375 16.7969H42.1875C42.2911 16.7969 42.3905 16.838 42.4637 16.9113C42.537 16.9845 42.5781 17.0839 42.5781 17.1875V39.0625ZM37.1094 27.3438C37.1094 27.73 36.9948 28.1077 36.7802 28.4289C36.5656 28.75 36.2606 29.0004 35.9037 29.1482C35.5468 29.296 35.1541 29.3347 34.7752 29.2593C34.3963 29.184 34.0483 28.998 33.7752 28.7248C33.502 28.4517 33.316 28.1037 33.2407 27.7248C33.1653 27.3459 33.204 26.9532 33.3518 26.5963C33.4996 26.2394 33.75 25.9344 34.0711 25.7198C34.3923 25.5052 34.77 25.3906 35.1562 25.3906C35.6743 25.3906 36.171 25.5964 36.5373 25.9627C36.9036 26.329 37.1094 26.8257 37.1094 27.3438Z"
                  fill="#0D2668"
                />
              </svg>
            </div>
          ...
          <div
            class="card shadow-lg px-2 mt-10 py-5 [@media(min-width:768px)]:w-[31%] [@media(min-width:500px)]:w-[48%] [@media(max-width:500px)]:w-[100%]"
          >
            <div
              class="img bg-[#EEF0F4] w-[55px] flex justify-center items-center h-[55px] rounded-full overflow-hidden mx-auto"
            >
              <img
                src="./src/images/isntagram-icon.jpg"
                class="w-full h-full"
                alt=""
              />
            </div>
          ...
          >
            ...
            >
              <img
                src="./src/images/youtube-icon.jpg"
                class="w-full h-full"
                alt=""
              />
            </div>
          ...
          >
            ...
            >
              <img
                src="./src/images/telegram-icon.jpg"
                class="w-full h-full"
                alt=""
              />
            </div>
      ...
      <div class="w-full bg-[#F3F4F7] mx-auto">
        <div class="sponsors mt-14 mx-auto max-w-screen-xl py-10">
          ...
          <div class="wrapper my-10 px-2 w-full mx-auto flex flex-wrap">
            <div
              class="item w-1/4 py-2 px-3 h-fit border-r-2 border-b-2 flex justify-center items-center overflow-hidden"
            >
              <a href="#">
                <img
                  src="./src/images/salamon.png"
                  class="[@media(min-width:500px)]:w-[100px] [@media(max-width:500px)]:w-full object-center"
                  alt=""
                />
              </a>
            </div>
            ...
            <div
              class="item w-1/4 py-[7.3px] px-3 h-fit border-b-2 flex justify-center items-center overflow-hidden"
            >
              <a href="#">
                <img
            ...
            <div
              class="item w-1/4 py-2 px-3 h-fit border-r-2 flex justify-center items-center overflow-hidden"
            >
              <a href="#">
                <img
                  src="./src/images/mazda.png"
                  class="[@media(min-width:500px)]:w-[100px] [@media(max-width:500px)]:w-full object-center"
                  alt=""
                />
              </a>
            ...
            <div
              class="item w-1/4 py-2 px-3 h-fit flex justify-center items-center overflow-hidden"
            >
              <a href="#">
                <img
      ...
      <div
        id="contacts"
        class="contact h-[450px] w-full flex flex-wrap justify-between items-start"
      >
        <div
          class="map-block [@media(min-width:800px)]:w-1/2 [@media(max-width:800px)]:w-full h-full"
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d2995.779923945947!2d69.25855277349936!3d41.33539869922227!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1z0KjQsNC50YXQvtC90YLQvtGF0YPRgNGB0LrQuNC5INGA0LDQudC-0L0sINCa0L7RiNC40LrRh9C4INC00L7QvCAxLCDQvNC40LrRgNC-0YDQsNC50L7QvSDQmtC-0YUt0L7RgtCwIA!5e0!3m2!1sen!2sus!4v1692075901730!5m2!1sen!2sus"
            class="w-full h-full"
            frameborder="0"
            scrolling="no"
            marginheight="0"
        ...
        <div
          class="text-block py-20 bg-[#0D2668] px-7 [@media(min-width:800px)]:w-1/2 [@media(min-width:800px)]:h-full [@media(max-width:800px)]:w-full [@media(max-width:800px)]:h-fit"
        >
          <!-- Text content start -->
          ...
          <div class="w-[220px] mt-8 flex justify-between">
            <a href="#" class="sm-icon">
              ...
              >
                ...
                />
                <path
                  d="M19.3625 11.3937C19.3625 11.8427 19.0096 12.2276 18.5606 12.2276C18.1115 12.2276 17.7266 11.8427 17.7587 11.3937C17.7587 10.9446 18.1115 10.5918 18.5606 10.5918C19.0096 10.5918 19.3625 10.9446 19.3625 11.3937Z"
                  fill="#0D2668"
                />
              </svg>
            </a>
            <a
              href="#"
              class="sm-icon flex justify-center items-center bg-[white] rounded-full w-[40px] h-[40px] p-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-full h-full"
