...
<html lang="en" class="scroll-smooth">
  ...
  <body>
    <div class="wrapper w-full flex min-h-[100vh] flex-col">
      <!-- Header start -->
        ...
        <div class="header shadow-md relative mx-auto px-2">
          ...
          >
            ...
            <div id="navbar-toggler" class="navbar-toggler block lg:hidden">
              <img
                class="[@media(min-width:450px)]:w-[25px] [@media(min-width:450px)]:h-[25px] [@media(max-width:450px)]:w-[20px] [@media(max-width:450px)]:h-[20px]"
            ...
            >
              ...
              <div class="link">
                <a href="{{ route('/') }}#branches" class="nav-link-styles">
                  @lang('front.filiallar')
                </a>
              </div>
              <div class="link">
                <a href="{{ route('/') }}#partners" class="nav-link-styles">
                  @lang('front.hamkorlar')
                </a>
              </div>
              <div class="link">
                <a href="{{ route('/') }}#contacts" class="nav-link-styles">
          ...
          <!-- offCanvas start -->
          <div
            id="header-off-canvas"
            class="overflow-hidden [&.open-canvas]:translate-x-0 w-[100vw] -translate-x-[100%] header-off-canvas absolute z-20 top-0 left-0 h-[100vh] bg-[rgba(0,0,0,0.3)]"
          >
            <!-- Left side start -->
            <div
              class="transition-all duration-[0.15s] left-side max-w-[400px] -translate-x-[100%] h-full mr-[60px] bg-white px-8 py-5"
            >
              <!-- Navbar links start -->
              <div class="links w-full">
                ...
                <div class="link my-3">
                  <a href="{{ route('/') }}#branches" class="nav-link-styles">@lang('front.filiallar')</a>
                </div>
                <div class="link my-3">
                  <a href="{{ route('/') }}#partners" class="nav-link-styles">@lang('front.hamkorlar')</a>
                </div>
                <div class="link">
                  <a href="{{ route('/') }}#contacts" class="nav-link-styles">@lang('front.kontaktlar')</a>
                </div>
              </div>
              <!-- Navbar links end -->
              ...
              <div
                class="w-[220px] mt-3 languages-content flex justify-between"
              >
                <div
      ...
      <div class="mt-[60px] [@media(max-width:449px)]:mt-[40px] back-img w-full mx-auto flex justify-center bg-no-repeat bg-center bg-cover items-center h-[220px]" style="background-image: url('{{ asset('front/src/images/first-back-img.jpg') }}')" >
        <div class="text-content mx-auto w-fit h-fit">
          ...
          <div class="decription">
            <a class="text-white text-center text-[20px]" href="{{ route('/') }}">@lang('front.bosh_sahifa')  - </a>
              
            <span class="text-white text-center text-[20px]"> @lang('front.biz_haqimizda')</span>
          </div>
          <!-- Description end -->
        </div>
      </div>
      ...
      <!-- Footer start -->
      <div
        class="footer sticky t-[100vh] w-full py-5 bg-[#0D1C45] px-3 mx-auto"
      >
        <div
        ...
        >
          ...
          >
            <a class="text-[white]"
              >“Uy Bozorim” @lang('front.himoyalangan')</a
            >
          </div>
          <div
